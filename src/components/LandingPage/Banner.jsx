...
const Banner = () => {
  return (
   <section className=" w-full banner mb:bg-center bg-right-top bg- bg-no-repeat bg-cover flex-1 flex justify-start items-center min-h-[70vh] " style={{backgroundImage: `url('/banner.png')`, transform:''}}>
